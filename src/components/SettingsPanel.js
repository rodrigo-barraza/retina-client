...
export default function SettingsPanel({ config, settings, onChange, hasAssistantImages, inferenceMode, readOnly = false, onSystemPromptClick, showSystemPromptModal = false, onCloseSystemPromptModal }) {
