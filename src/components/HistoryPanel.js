...
import { MessageSquare, Plus, Trash2, Search, X as XIcon, Type, Image, Volume2, FileText as DocIcon } from "lucide-react";
...
function getModalities(messages) {
    const modalities = { textIn: false, textOut: false, imageIn: false, imageOut: false, audioIn: false, audioOut: false, docIn: false };
...
export default function HistoryPanel({
    ...
    const filtered = useMemo(() => {
        return conversations.filter((conv) => {
            ...
            if (activeModality) {
                ...
                if (!mod) return false;
                const hasModality = mod[`${activeModality}In`] || mod[`${activeModality}Out`];
    ...
    }, [conversations, searchQuery, activeModality, activeProvider, showProject, showUsername]);
                        ...
                        >
                            ...
                            <div className={styles.content}>
                                ...
                                <div className={styles.modalities}>
                                    ...
                                    {(mod.textIn || mod.imageIn || mod.audioIn || mod.docIn) && (mod.textOut || mod.imageOut || mod.audioOut) && (
